...
extern char   UFDBglobalRedirectURL[1024];
extern char   UFDBglobalRedirectCategoryURL[1024];
extern char   UFDBglobalRedirectClientCategoryURL[1024];
extern char   UFDBglobalRedirectNoDefaultACLCategoryURL[1024];
extern char   UFDBglobalRedirectNoDefaultACLClientCategoryURL[1024];
extern char   UFDBglobalRedirectNoDefaultRedirectClientCategoryURL[1024];

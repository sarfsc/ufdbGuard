...
char   UFDBglobalFatalErrorRedirect[1024] = UFDB_DEFAULT_REDIRECTION_URL 
		"category=fatal-error";
char   UFDBglobalLoadingDatabaseRedirect[1024] = UFDB_DEFAULT_REDIRECTION_URL 
		"category=loading-database";
char   UFDBglobalRedirectURL[1024] = UFDB_DEFAULT_REDIRECTION_URL;
char   UFDBglobalRedirectCategoryURL[1024] = UFDB_DEFAULT_REDIRECTION_URL UFDB_REDIRECTION_CATEGORY_URL;
char   UFDBglobalRedirectClientCategoryURL[1024] = UFDB_DEFAULT_REDIRECTION_URL UFDB_REDIRECTION_CLIENT_CATEGORY_URL;
char   UFDBglobalRedirectNoDefaultACLCategoryURL[1024] = UFDB_DEFAULT_REDIRECTION_URL UFDB_REDIRECTION_NO_DEFAULT_ACL_CATEGORY_URL;
char   UFDBglobalRedirectNoDefaultACLClientCategoryURL[1024] = UFDB_DEFAULT_REDIRECTION_URL UFDB_REDIRECTION_NO_DEFAULT_ACL_CLIENT_CATEGORY_URL;
char   UFDBglobalRedirectNoDefaultRedirectClientCategoryURL[1024] = UFDB_DEFAULT_REDIRECTION_URL UFDB_REDIRECTION_NO_DEFAULT_REDIRECT_CLIENT_CATEGORY_URL;

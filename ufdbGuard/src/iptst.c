...
int main()
{
   ...
   UFDBregisterCountedIP( "10.63.83.107" );
   ...
   for (i = 10000000; i>0; i--)
      UFDBregisterCountedIP( "10.22.183.177" );
#endif
   printf( "#IP: %lu (17)\n", UFDBgetNumberOfRegisteredIPs() );
   ...
   UFDBregisterCountedIP( "11.0.0.14" );

   UFDBregisterCountedIP( "11.0.0.15" );

   UFDBregisterCountedIP( "11.1.1.14" );
   printf( "#IP: %lu (50)\n", UFDBgetNumberOfRegisteredIPs() );

   UFDBregisterCountedIP( "11.255.255.14" );
   UFDBregisterCountedIP( "11.255.255.254" );
   UFDBregisterCountedIP( "11.255.255.255" );
